...
<table class="bordered highlight">
    ...
    <c:forEach var="brand" items="${listDto.list}" varStatus="loopCounter">
        <tr>
            ...
            <%--<td><c:out value="${brand.createdDate}" /></td>--%>
            <%--<td><c:out value="${brand.lastModifiedDate}" /></td>--%>
            ...
            <%--<td><fmt:formatDate pattern="yyyy-MM-dd" value="${brand.createdDate}" /></td>--%>
            <%--<td><fmt:formatDate pattern="yyyy-MM-dd" value="${brand.lastModifiedDate}" /></td>--%>
            <td class="right">
