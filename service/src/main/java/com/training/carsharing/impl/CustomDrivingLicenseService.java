...
@Service
public class CustomDrivingLicenseService extends CustomAbstractService<DrivingLicense, DrivingLicenseRepository, Integer> implements DrivingLicenseService {
