package com.training.carsharing.tag;

import com.training.carsharing.dto.ListDto;
import com.training.carsharing.dto.SortDto;
...
public class SortLink extends SimpleTagSupport {
    ...
    public void doTag() throws JspException, IOException {
        ...
        final ListDto<?> listDto = (ListDto<?>) jspContext.findAttribute(ListDto.SESSION_ATTR_NAME);
        if (listDto == null) {
