...
<table class="bordered highlight">
    ...
    <tr>
        ...
        <th><mytaglib:sort-link pageUrl="${baseUrl}" column="address">address</mytaglib:sort-link></th>
        <th><mytaglib:sort-link pageUrl="${baseUrl}" column="price">price</mytaglib:sort-link></th>
        <th><mytaglib:sort-link pageUrl="${baseUrl}" column="body">body</mytaglib:sort-link></th>
        <th><mytaglib:sort-link pageUrl="${baseUrl}" column="active">active</mytaglib:sort-link></th>
    ...
    <c:forEach var="ad" items="${listDto.list}" varStatus="loopCounter">
        <tr>
            <td><c:out value="${ad.id}" /></td>
            <td><c:out value="${ad.carPlate}" /></td>
            <td><c:out value="${ad.userAccountEmail}" /></td>
            <td><c:out value="${ad.address}" /></td>
            <td><c:out value="${ad.price}" /></td>
            <td><c:out value="${ad.body}" /></td>
            <td><c:out value="${ad.active}" /></td>
            <td><c:out value="${ad.version}" /></td>
            <td><javatime:format value="${ad.createdDate}" pattern="dd.MM.yyyy / HH:mm:ss" /></td>
            <td><javatime:format value="${ad.lastModifiedDate}" pattern="dd.MM.yyyy / HH:mm:ss" /></td>
            <td class="right">
                <a class="btn-floating"	href="${baseUrl}/${ad.id}">
                    <i class="material-icons">info</i>
                </a>
                <a class="btn-floating"	href="${baseUrl}/${ad.id}/edit">
                    <i class="material-icons">edit</i>
                </a>
                <a class="btn-floating red" href="${baseUrl}/${ad.id}/delete">
